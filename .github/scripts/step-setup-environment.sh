...
# PUSH_FALLBACK_REV_RANGE:          The fallback value for linting commits.  This should be set to either "HEAD" (all commits) or the first compatible commit in your Git History.
